...
const T = {
  en: {
    ...
    card3_title: 'Infrastructure', card3_body: 'Linux, Docker, cloud, networking, CI/CD, everything related to Protheus Infrastructure. I care about how things run in production — not just how they are written.',
  ...
  pt: {
    ...
    card3_title: 'Infraestrutura', card3_body: 'Linux, Docker, cloud, redes, CI/CD, tudo para a Infraestrutura Protheus. Me importo com como as coisas rodam em produção — não só como são escritas.',
  ...
  es: {
    ...
    hero_tag: 'Disponible para nuevos desafíos', hero_cta1: 'Ver proyectos →', scroll: 'desplazar',
    ...
    card3_title: 'Infraestructura', card3_body: 'Linux, Docker, cloud, redes, CI/CD, todo relacionado con la Infraestructura Protheus. Me importa cómo funcionan las cosas en producción — no solo cómo están escritas.',
